...
export default function TrackingNumberConfirmed() {
  return (
    <div>
      <HeaderSeo
        title="GanniRepeat - Tracking Number Confirmed"
        description="GanniRepeat - Tracking Number Confirmed"
      />
      ...
      <div className="pb-20 pt-20">
        <div className="container text-center m-auto px-4">
          ...
          <p className="text-sm mb-12">
            Your tracking number has been added. You will receive an email once
          ...
          <div className="w-full lg:w-420 m-auto">
            ...
            <Link href="/sell/step-1">
              <a
                href="#"
                className="font-helveticaNeue500 text-2xl group text-center px-3 py-4 transition-all border border-dark  text-dark hover:border-dark hover:text-white hover:bg-dark flex items-center justify-center uppercase"
              >
                <svg
                  className="mr-2"
                  width="25"

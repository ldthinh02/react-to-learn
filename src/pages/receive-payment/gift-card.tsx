...
const GiftCard = () => {
  return (
    <div>
      <HeaderSeo
        title="GanniRepeat - Gift Card"
        description="GanniRepeat - Gift Card"
      />
      ...
      <div className="pb-20 pt-20">
        <div className="container text-center m-auto px-4">
          ...
          <h2 className="font-helveticaNeue500 text-pink uppercase text-4xl mb-6">
            Your ganni gift card is on the way!
          </h2>
          <p className="text-sm mb-6">
            Thank you for choosing your payment in a GANNI gift card.
          </p>
          <p className="text-sm mb-12">
            You will receive an email with your gift card details shortly.
          </p>

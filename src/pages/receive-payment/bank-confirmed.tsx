...
const BankTransfer = () => {
  return (
    <div>
      <HeaderSeo
        title="GanniRepeat - Bank Confirmed"
        description="GanniRepeat - Bank Confirmed"
      />
      ...
      <div className="pb-20 pt-20">
        <div className="container text-center m-auto px-4">
          ...
          <p className="text-sm mb-6">
            You can expect to receive your payment in your account within 3
            working days.
          </p>
          <p className="text-sm mb-12">
            Please note, this timeframe may vary depending on your bank.
          </p>

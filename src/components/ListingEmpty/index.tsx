...
const ListingEmpty = ({ title, sub_title, isNewIn, isSell }: ListingEmpty) => {
  ...
  return (
    <div className="w-full">
      ...
      <p className="mb-6">{sub_title}</p>
      {isNewIn && (
        <Link href="/section/new-in">
          <a className="group text-center px-3 pt-2 pb-3 transition-all border border-dark  text-dark hover:border-dark hover:text-white hover:bg-dark flex items-center justify-center mb-4 uppercase">
            <svg
              className="mr-2"
              width="24"
              height="15"
            ...
            <span className="font-helveticaNeue500 text-2xl leading-none pt-2">
              Shop new in
            </span>
          </a>
        </Link>
      ...
      {isSell && (
        <a
          className="group text-center px-3 pt-2 pb-3 transition-all border border-dark  text-dark hover:border-dark hover:text-white hover:bg-dark flex items-center justify-center uppercase cursor-pointer"
          onClick={onClickSell}
        >
          <svg
            className="mr-2"
